...
class TransportMetro extends StatefulWidget {
  TransportMetro({Key key, @required this.subject}) :
        super(key: key);
  final Subjects subject;
  @override
  _TransportMetroState createState() => _TransportMetroState();
}

class _TransportMetroState extends State<TransportMetro> {
  int currentIndex = -1;
  var viewLines = true;
  List<LineData> litem = [];
